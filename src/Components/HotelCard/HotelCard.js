...
const HotelCard = (props) => {
  ...
  return (
    <div>
      <Card className='m-2' style={{width:'295px',height:'327px'}} onClick={()=>navigate('/hotel/'+props.hotel.id+'/details')}>
        ...
        <CardBody>
          ...
          <CardSubtitle style={{whiteSpace:'nowrap'}}>Azerbaijan,{props.hotel.address.city.name},{props.hotel.address.addressLine}</CardSubtitle>
