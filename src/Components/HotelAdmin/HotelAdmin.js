...
export default function HotelAdmin() {
    ...
    const roomCount = useSelector(state=>state.roomCountReducer)
    const adultCount = useSelector(state=>state.adultCountReducer)
    const childreenCount = useSelector(state=>state.childreenCountReducer)
                    ...
                    <Row>
                        ...
                        <Col md='6'>
                            ...
                            <CardFooter className='d-flex'>
                                ...
                                <Button onClick={()=>document.getElementById('bookSection').style='visible'} color='primary'>Book Now</Button>
